...
See the section "Disable-wallet mode" to build Shard Core without wallet.
...
If you want to build Shard-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Shard Core distributions and independently built
