...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shard-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shard-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shard transaction") + "\n" +
              "  shard-tx [options] -create [commands]   " + _("Create hex-encoded shard transaction") + "\n" +
              "\n";
