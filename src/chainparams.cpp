...
{
    const char* pszTimestamp = "Mary had some little fans";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517465951, 67112, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xeaa0a4ae01ee16c7fc57947c664fb45437435005c0eeb7cfb04054190842e5a3"));
        assert(genesis.hashMerkleRoot == uint256S("0xdb9ead59827c4665c0989e8475cb8e1e283c9c665af76bfc2eed72d11c38bce8"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("seed-a.shard.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.shardtools.com", true);
        vSeeds.emplace_back("dnsseed.shardpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 2709624, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbaa87d5e039e5fe1396ef6d4c0c345e0f84b9acc170878601dc44fcb09a227ff"));
        assert(genesis.hashMerkleRoot == uint256S("0xdb9ead59827c4665c0989e8475cb8e1e283c9c665af76bfc2eed72d11c38bce8"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.shardtools.com", true);
        vSeeds.emplace_back("seed-b.shard.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x240c72e172ed96b50da7e7d673c1abb878d87ad83b436a43c0fd4b9837ea990b"));
        assert(genesis.hashMerkleRoot == uint256S("0xdb9ead59827c4665c0989e8475cb8e1e283c9c665af76bfc2eed72d11c38bce8"));
